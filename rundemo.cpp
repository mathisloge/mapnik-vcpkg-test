...
int main(int, char**)
{
    ...
    try
    {
...
#if defined(MAPNIK_PLUGINS_DIR)
        //"/mnt/d/dev/vcpkg_mapnik/installed/x64-linux/debug/lib/mapnik/input/"
        datasource_cache::instance().register_datasources(MAPNIK_PLUGINS_DIR);
#endif
        freetype_engine::register_font(MAPNIK_FONTS_DIR "/dejavu-fonts-ttf-2.37/ttf/DejaVuSans.ttf");
        ...
        */
        ...
        std::cout << "Three maps have been rendered using Cairo in the current "
                     "directory:\n"
                     "- cairo-demo.png\n"
                     "- cairo-demo256.png\n"
                     "- cairo-demo.pdf\n"
